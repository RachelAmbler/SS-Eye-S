...
namespace RandomThunks.API.SSiS
{
    ...
    public class iEventHandler : iControlFlowTask
    {
        iControlFlowTask _parent = null;
        DtsEventHandler _handler = null;
        internal iEventHandler(iControlFlowTask task, iEventType eventType)
        {
            _handler = task.TaskHost.EventHandlers.Add(eventType.ToString()) as DtsEventHandler;
            _parent = task;
        }
    }
}
