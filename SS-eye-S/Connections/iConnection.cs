...
namespace RandomThunks.API.SSiS
{
    public class iConnection : IDisposable
    {
        ...
        public enum ConnectionType
        {
            ...
            SMTP,
            /// <Summary>
            ///   Connection manager for Microsoft Windows Management Instrumentation (WMI) connections.
            /// </Summary>
            WMI,
        }
        ...
        internal iConnection(Package package, ConnectionType connectionType, string name, string description)
        {

            string connectionTypeStr = connectionType.ToString();
            switch (connectionType)
            {
                case ConnectionType.ADO_NET_SQL:
                    connectionTypeStr = "ADO.NET:SQL";
                    break;
                case ConnectionType.ADO_NET_OLEDB:
                    connectionTypeStr = "ADO.NET:OLEDB";
                    break;
            }

            _connectionManager = package.Connections.Add(connectionTypeStr);
            ...
            switch(connectionType)
            {
                ...
                case ConnectionType.FILE:
                    ...
                    break;
                case ConnectionType.MULTIFLATFILE:

                    break;
                case ConnectionType.MULTIFILE:

                    break;
                case ConnectionType.SQLMOBILE:

                    break;
                case ConnectionType.MSOLAP100:
        ...
        {
            _connectionManager.SetExpression(propertyName, expression);
        }

        public void SetExpression(string propertyName, iVariable variable)
        {
            _connectionManager.SetExpression(propertyName, variable.ToString());
        }
    }
}