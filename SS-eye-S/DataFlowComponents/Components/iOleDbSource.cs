...
{
    [DataFlowType("DTSAdapter.OLEDBSource")]
    public class iOleDbSource : iDataFlowComponent
    {
        iVariable _variable;

        DataSourceType _mode = DataSourceType.SqlCommand;
        SourceType _source = SourceType.Static;
        ...
        {
            if (_mode == DataSourceType.Rowset && _source == SourceType.Static)
                SetProperty("AccessMode", 0);
            if (_mode == DataSourceType.Rowset && _source == SourceType.Variable)
                SetProperty("AccessMode", 1);
            if (_mode == DataSourceType.SqlCommand && _source == SourceType.Static)
                SetProperty("AccessMode", 2);
            if (_mode == DataSourceType.SqlCommand && _source == SourceType.Variable)
        ...
        public SourceType ScriptSource
        {
            get { return _source; }
            set { _source = value; }
        }
        public string Text
        {
            set
            {
                _source = SourceType.Static;
                SetProperty("SqlCommandVariable", "");
        ...
        public iVariable Variable
        {
            set
            {
                _source = SourceType.Variable;
                SetProperty("SqlCommandVariable", value.SimpleName);
